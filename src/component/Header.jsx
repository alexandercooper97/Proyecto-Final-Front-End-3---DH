      ...
      <div className="row">
        <div className="col-12 bg-primary d-flex justify-content-between px-5">
          <ul className="d-flex gap-5 align-items-center m-0 p-0 py-3 ">
            ...
            <li className="list-unstyled text-light p-0 pointer">ACERCA DE</li>
            <li className="list-unstyled text-light p-0 pointer">CONTACTO</li>
          </ul>
          <ul className="m-0 p-0 py-3 position-relative">
            ...
            <span
              ...
              style={{ backgroundColor: "green", right:'-45%' }}
            >
